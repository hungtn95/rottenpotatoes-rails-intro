class MoviesController < ApplicationController
  ...
  def index
    ...
    flash.keep and redirect_to movies_path(ratings: session[:ratings], order: session[:sort_by], submit: 'Refresh') and return if params[:ratings].nil? and params[:sort_by].nil?
